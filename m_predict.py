...
parser.add_argument('--dev_data', default='data/dev_data.pkl', type=str, help='Validation Set')
parser.add_argument('--dev_parsed', default='data/dev_parsed.json', type=str, help='Validation Set')
...
with open(args.dev_parsed) as f:
    samples = json.load(f)
print('Done!')
